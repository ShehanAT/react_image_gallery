...
class Dogs extends Component {
    ...
    handleEraseResults = () => {
      ...
      handleDogPhotos = searchTerm => {
        console.log(this.state.searchString);
        var pageNum = Math.floor(Math.random() * 20);
        axios({ 
          method: 'GET',
          url: 'https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key='+apikey+'&tags=DOGS&per_page=9&page='+pageNum+'&format=json&nojsoncallback=1',
          header: {
